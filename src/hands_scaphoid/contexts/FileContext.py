...
class FileContext(Context):
    ...
    def __init__(self, path: PathLike, create: bool = True, mode: str = 'r+', 
    ...
    def write_line(self, content: str) -> 'FileContext':
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would append to file: {self.resolve_path()}[/dim]")
            return self
    ...
    def read_content(self) -> str:
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would read file: {self.resolve_path()}[/dim]")
    ...
    def overwrite_content(self, content: str) -> 'FileContext':
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would overwrite file: {self.resolve_path()}[/dim]")
            return self
    ...
    def copy_to(self, target_path: PathLike) -> 'FileContext':
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would copy file: {self.resolve_path()} → {target_path}[/dim]")
            return self
    ...
    def get_file_size(self) -> int:
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would get file size: {self.resolve_path()}[/dim]")
            return 0
    ...
    def delete(self) -> None:
        ...
        """
        if self.dry_run:
            console.print(f"[dim][DRY RUN] Would delete file: {self.resolve_path()}[/dim]")
            return
